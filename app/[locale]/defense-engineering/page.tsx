...
export default async function DefensePage({
  ...
  const capabilities = [
    {
      title: t("capabilities.uas.title"),
      description: t("capabilities.uas.description"),
      icon: <Shield className="h-8 w-8 text-primary" />,
    },
    {
      title: t("capabilities.isr.title"),
      description: t("capabilities.isr.description"),
      icon: <Search className="h-8 w-8 text-primary" />,
    },
    {
      title: t("capabilities.perimeter.title"),
      description: t("capabilities.perimeter.description"),
    ...
    {
      title: t("capabilities.maintenance.title"),
      description: t("capabilities.maintenance.description"),
  ...
  return (
    <div className="vertical-defense relative overflow-hidden">
      <div className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[520px] bg-[radial-gradient(circle_at_top_left,_rgba(31,41,55,0.12),_transparent_55%),radial-gradient(circle_at_top_right,_rgba(31,41,55,0.06),_transparent_40%)]" />
      <div className="pointer-events-none absolute right-[-8rem] top-24 -z-10 hidden h-72 w-72 rounded-full bg-primary/10 blur-3xl lg:block" />
            ...
            <div className="p-8 sm:p-10 lg:p-12">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <Button asChild variant="outline" size="lg">
                  <Link href="#capabilities">{t("hero.cta2")}</Link>
                </Button>
              </div>
            </div>
      ...
      <Section className="bg-muted/35" id="capabilities" title={t("capabilities.title")}>
      ...
      <section className="py-8 md:py-10">
        <div className="container mx-auto px-4">
          <div className="rounded-[32px] border bg-muted/35 p-6 shadow-sm sm:p-8 lg:p-10">
